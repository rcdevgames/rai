          ...
          Expanded(
            child: Container(
              ...
              child: mySwitchOut.length > 0
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                      child: Text(
                                          mySwitchOut[i].status == 'Active'
                                              ? "${mySwitchOut[i].status} (${mySwitchOut[i].expiredDate.difference(widget.businessDate).inDays} Days Left)"
                                              : "${mySwitchOut[i].status}",
                                          style: TextStyle(
                                              fontWeight: FontWeight.w700,
                                              color: mySwitchOut[i].status == 'Active'
                                                  ? Pigment.fromString("##69be28")
                  ...
                  : Column(
                      children: <Widget>[Text("You do not have any switch out")],
                    ),
            ),
          )
        ],
        ...
        Scaffold(
            ...
            children: <Widget>[
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                        ...
                        children: <TableRow>[
                          ...
                          TableRow(children: <Widget>[
                            Padding(
                              ...
                              child: Text(formatMoney.format(widget.item.quantity, true),
                                  style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: FittedBox(
                          child: LinearPercentIndicator(
                            ...
                            lineHeight: 27,
                            percent: detailSavingBloc.countPercentage(
                                widget.businessDate, widget.item.maturityDate, widget.item.startDate),
                      ...
                      Text(
                          "${widget.item.maturityDate.difference(widget.businessDate).inDays} days left till maturity on ${formatDate(widget.item.maturityDate, [
                            dd,
                            ' ',
                            M,
                            ' ',
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10), color: Theme.of(context).primaryColor.withOpacity(0.05)),
                  child: StreamBuilder(
                      initialData: 0,
                      stream: detailSavingBloc.getIndex,
                      builder: (context, AsyncSnapshot<int> snapshot) {
          ...
          bottomNavigationBar: ButtonBottom(
            ...
            onTap: () => Navigator.of(context)
                .push(MaterialPageRoute(builder: (ctx) => ExitEarlyPage(widget.item, widget.businessDate))),
          ),
        ),
        StreamBuilder(
            initialData: false,
