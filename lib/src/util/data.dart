...
class Static {
  ...
  // Dev
  static const String MCS_URL =
      "https://E0173A94EDA9476B95743126BF663FED.mobile.ocp.oraclecloud.com:443/mobile/custom/RAI/rai/";
  static const String REGISTER_URL =
      "https://E0173A94EDA9476B95743126BF663FED.mobile.ocp.oraclecloud.com:443/mobile/platform/devices/register";
  static const String OAUTH_URL =
      "https://idcs-98c6f5b2de264ab9bab089f2d5a44f31.identity.oraclecloud.com/oauth2/v1/token";

  static const String OAUTHTTOKENENDPOINT =
      'https://idcs-98c6f5b2de264ab9bab089f2d5a44f31.identity.oraclecloud.com/oauth2/v1/token';
  static const String OAUTHSCOPE =
      'https://E0173A94EDA9476B95743126BF663FED.mobile.ocp.oraclecloud.com:443urn:opc:resource:consumer::all';
  ...
  // UAT
  static const String UAT_MCS_URL =
      "https://E0173A94EDA9476B95743126BF663FED.mobile.ocp.oraclecloud.com:443/mobile/custom/RAIUAT/rai/";
  static const String UAT_REGISTER_URL =
      "https://8A5D210F6BD34357BCFA3BC0C26C3F6C.mobile.ocp.oraclecloud.com:443/mobile/platform/devices/register";
  static const String UAT_OAUTH_URL =
      "https://idcs-98c6f5b2de264ab9bab089f2d5a44f31.identity.oraclecloud.com/oauth2/v1/token";

  static const String UAT_OAUTHTTOKENENDPOINT =
      'https://idcs-98c6f5b2de264ab9bab089f2d5a44f31.identity.oraclecloud.com/oauth2/v1/token';
  static const String UAT_OAUTHSCOPE =
      'https://E0173A94EDA9476B95743126BF663FED.mobile.ocp.oraclecloud.com:443urn:opc:resource:consumer::all';
  ...
  // Production
  static const String PROD_MCS_URL =
      "https://D43098C4B31048B1BB0A6578E6A489CF.mobile.ocp.oraclecloud.com:443/mobile/custom/RAI/rai/";
  static const String PROD_REGISTER_URL =
      "https://D43098C4B31048B1BB0A6578E6A489CF.mobile.ocp.oraclecloud.com:443/mobile/platform/devices/register";
  static const String PROD_OAUTH_URL =
      "https://idcs-3d71481e2dc346c1b5d929ab3c4f3962.identity.oraclecloud.com/oauth2/v1/token";

  static const String PROD_OAUTHTTOKENENDPOINT =
      'https://idcs-3d71481e2dc346c1b5d929ab3c4f3962.identity.oraclecloud.com/oauth2/v1/token';
  static const String PROD_OAUTHSCOPE =
      'https://D43098C4B31048B1BB0A6578E6A489CF.mobile.ocp.oraclecloud.com:443urn:opc:resource:consumer::all';
  ...
  static const List<Map<String, String>> LIST_TOUR = [
    ...
    {'title': '2', 'description': 'Decide the amount you\'d like to save.', 'color': '#FFD603'},
    {'title': '3', 'description': 'Choose the deposit that\'s best for you.', 'color': '#E5003E'},
    {'title': '4', 'description': 'Watch your savings grow to maturity.', 'color': '#009636'},
    {'title': '5', 'description': 'Need your money back early? Explore our Switch Out options.', 'color': '#009636'},
    {'title': '6', 'description': 'Explore attractive offers from the OneUp community.', 'color': '#009636'}
  ];
    ...
    },
    {
      ...
      'articles': [
        ...
        },
        {
          ...
          'body':
              "You can see the details of your transactions and your deposits on the app. From time to time you may also receive notifications. In future we will introduce features to provide statements of your deposits.",
        },
      ],
    },
    {
