...
class Static {
  ...
  static List<Help> LIST_HELP = helpFromJson(json.encode(
      [
        {
          'categoryName': 'Making deposits',
          'articles': [
            {
              'id': 1,
              'title': 'How do I make a Time Deposit?',
              'body':
              "Simply navigate to the 'Deposit Offers' screen in the OneUp App. Enter the amount you would like to switch up and select the length of time you would like to save for. Once this is complete, click Confirm Deposit.\n\nNote: you will need to have sufficient balance available in your External Linked Accounts - please see the relevant section below.\n\nEach Time Deposit can be as little as GBP100 and there is no maximum limit.\n\nThere is also no limit to what you can save with OneUp.",
            },
            {
              'id': 2,
              'title': 'What does Period Mean?',
              'body':
        ...
        {
          'categoryName': 'Managing deposits',
          'articles': [
            {
              'id': 1,
              'title': 'What does AER mean?',
              'body':
              'AER is short for Annual Equivalent Rate. You will see AER quoted on Savings Accounts provided by a wide range of Banks and other providers - this allows you to compare interest rates across these different providers.',
            },
            {
              'id': 2,
              'title': 'What does Gross Interest mean?',
              'body':
              'Gross Interest is the annual rate of interest you will get before any charges or taxes are deducted. Gross Interest is usually shown as a percentage rate. Depending on your circumstances OneUp may be obliged by HMRC to withhold income tax on interest.',
            },
            {
              'id': 3,
              'title': 'What do I do when my deposit matures?',
              'body':
              'The day after your deposit matures e.g. 6, 9 or 12 months after you make your deposit, you will receive back the original amount deposited (often called "Principal") and the interest you have earned. This combined amount will be automatically credited to your External Linked Account. If you have two or more External Linked Accounts, it will be credited to the "Default" External Linked Account.',
            },
          ],
        },
        {
          ...
          'articles': [
            {
              'id': 1,
              'title': 'What is a Switch Out?',
              'body':
              'When you make a deposit you choose the period of time for which an interest rate is guaranteed. Typically the longer you agree to deposit your money for, the higher the interest rate you will receive. However sometimes you may wish to withdraw some or all of your money from your deposit earlier than the deposit maturity date.\n\nOneUp uses an innovative way of matching full or partial withdrawals from a Time Deposit by one OneUp member with a new deposit by another OneUp member which allows you to preserve as much of your earned interest as possible.',
            },
            {
              'id': 2,
              'title': 'How do I make a Switch Out ?',
              'body':
              'All your deposits are listed in the My Money tab of the OneUp app. Tapping a deposit will show details of the deposit e.g. maturity date, interest rate, amount deposited etc. At the bottom of this Deposit Details screen you will see Explore Switch Out Options. Click this button and choose how much of your deposit you wish to withdraw.',
            },
            {
              'id': 3,
              'title': 'How is my interest calculated in a Switch Out?',
              'body':
              'If you trigger a Switch Out, the OneUp App will try to match your withdrawal with a new deposit over the next 30 days.\n\nIf a match occurs in the first 7 days you will receive all of your original deposit, plus all of the interest which you earned up to the point in time when you triggered a Switch Out.\n\nIf a match occurs between 8 and 30 days, we will deduct a small proportion of the interest you have earned to date in order to incentivise a new depositor.\n\nThis process continues with the proportion of interest deducted gradually increasing each week in order to help you find a deposit match.\n\nIf in the event that no matching depositor can be found before 30 days has passed, we will repay your original deposit but with the High Street interest rate applied to it rather than the Deposit Interest rate defined when you made your original deposit. This means that in a worse case scenario where no deposit match can be found, you will still receive an interest rate broadly equivalent to that which your funds would have attracted if they had been left in a High Street Bank Current account.',
            },
            {
              'id': 4,
              'title': 'What is the "High Street" Interest Rate?',
              'body':
              'High Street Interest rate is a rate calculated to be the average of that which applies to standard current accounts provided by the Big 4 Banks in the UK. Please see details here on how this rate is calculated.',
            },
            {
              'id': 5,
              'title': 'Can I cancel a Switch Out request if I choose to?',
              'body':
              'So long as a Switch Out match has not already occurred you can cancel a Switch Out at any time. Simply navigate to the Deposit in question via the My Money tab, and click the "My Switch Outs" tab. You can identify Deposits for which a Switch Out is live by the "Switch Out" text in the top right corner of the Deposit Summary.\n\nIf a Switch Out request is cancelled, then the deposit will continue to perform as though the Switch Out 0request had never been made.',
            },
            {
              'id': 6,
              'title':
              'Am I limited in how many Deposits or Switch Outs I can make?',
              'body':
              'Not in a way that should impact your genuine needs. We limit total transactions to 30 in any one month. Also if you withdraw money (in whole or in part) through a Switch Out, you cannot buy a deposit of the same maturity and interest rate within the next seven days.',
            },
          ],
        },
        {
          'categoryName': 'Linked Accounts',
          'articles': [
            {
              'id': 1,
              'title': 'What is an External Linked Account?',
              'body':
              'An External Linked Account is a Bank Account account which you control, but which is provided by another Bank. Using industry standard technology and only if you allow us to, we are able to securely request the balance of your External Account. This helps you see in one place how much money which may be only attracting very low rates of interest. If you allow us, and specifically authorise within the OneUp app, we can trigger a transfer of cash from your external account to OneUp in order to easily complete your Deposit.',
            },
            {
              'id': 2,
              'title': 'How do I link an External Account?',
              'body':
              'The linking of External Accounts are simulated in the Alpha version of OneUp. More details of how to link accounts (using Open Banking Standards) will be provided in due course.',
            },
            {
              'id': 3,
              'title': 'What does "Default External Linked Account" mean?',
              'body':
              'Your Default External Linked Account is the account which will be used as the source of funds for any new deposits, and as the account to which any maturing deposits, or proceeds from Switch Out, are credited.\n\nYou can see a list of your External Linked Accounts in the Linked Accounts section of the My Profile tab of the OneUp app. Swiping the account allows you to edit details and change default preferences.',
            },
          ],
        },
        {
